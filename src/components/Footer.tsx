      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 md:py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10">
        ...
        <div className="col-span-1 sm:col-span-2">
          ...
          <div className="flex gap-2">
            <a href="https://www.linkedin.com/company/146580918/admin/dashboard/" target="_blank" rel="noreferrer" aria-label="LinkedIn" title="LinkedIn" className="w-10 h-10 rounded-lg border border-white/25 bg-white/10 flex items-center justify-center text-gray-100 hover:text-white hover:bg-white/20 transition-colors">
